...
CHECKPOINT_FOLDERS_DICT = {
    ...
    "gtr_msmarco__msl128__100epoch": "/localdata/whuak/geia_graph/vec2text/vec2text/saves/gtr-1",
    ...
    "gtr-arxiv-w2v-t5b":  os.path.expanduser('~/github/geia_graph/vec2text/vec2text/saves/gtr-arxiv-w2v-t5b'),
    "gtr-arxiv-graph-t5b": os.path.expanduser('~/github/geia_graph/vec2text/vec2text/saves/gtr-arxiv-graph-t5b'),
    "gtr-arxiv-graph-jxm": os.path.expanduser('~/github/geia_graph/vec2text/vec2text/saves/gtr-arxiv-graph-jxm'),
}
