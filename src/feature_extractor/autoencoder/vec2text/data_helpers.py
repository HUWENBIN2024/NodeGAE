...
def dataset_from_args(data_args: DataArguments) -> datasets.DatasetDict:
    ...
    if data_args.dataset_name == "nq":
    ...
    elif data_args.dataset_name == 'yelp':
        raw_datasets = datasets.load_dataset("yelp_review_full")
        raw_datasets["validation"] = raw_datasets["test"]
    elif data_args.dataset_name == 'Egbertjing/arxiv_title':
        raw_datasets = datasets.load_dataset("Egbertjing/arxiv_title")
        raw_datasets["validation"] = raw_datasets["test"]
    elif data_args.dataset_name == 'Egbertjing/arxiv_full_graph_emb':
        raw_datasets = datasets.load_dataset("Egbertjing/arxiv_full_graph_emb")
        raw_datasets["validation"] = raw_datasets["test"]
    elif data_args.dataset_name == 'hubin/arxiv_title':
        raw_datasets = datasets.load_dataset("hubin/arxiv_title")
        raw_datasets["validation"] = raw_datasets["test"]
    elif data_args.dataset_name == 'hubin/arxiv_title_all_for_train':
        raw_datasets = datasets.load_dataset("hubin/arxiv_title_all_for_train")
        raw_datasets["validation"] = raw_datasets["train"]
    elif data_args.dataset_name == 'hubin/arxiv_title_abstract':
        raw_datasets = datasets.load_dataset("hubin/arxiv_title_abstract")
        raw_datasets["validation"] = raw_datasets["test"]
        ...
        raw_datasets["validation"] = raw_datasets["train"]
    elif data_args.dataset_name == 'hubin/arxiv_title_abs_with_gpt_pred':
        raw_datasets = datasets.load_dataset("hubin/arxiv_title_abs_with_gpt_pred")
        raw_datasets["validation"] = raw_datasets["train"]
    else:        
