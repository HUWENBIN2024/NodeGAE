...
DATASET_NAMES = [
    ...
    "Egbertjing/arxiv_full_graph_emb",
    "hubin/arxiv_title",
    "hubin/arxiv_title_all_for_train",
    "hubin/arxiv_title_abstract",
...
class ModelArguments:
    ...
    pt_load_data_from: str = field(
        default="data_with_1024",
        metadata={
        },
    )
    auto_encoder_name: str = field(
        default="sentence-transformers/sentence-t5-base",
        metadata={
        },
    )
    is_link_prediction: bool = field(
        default=False,
        metadata={
            "help": "if set, we are doing link prediction, otherwise, node classification."
        },
    )
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    use_infonce_loss: bool = field(
        default=False,
        metadata={
            "help": "if set, uses the infonce loss for neighbour reconstruction"
        },
    )
    infonce_loss_weight: float = field(
        default=1.0,
        metadata={
            "help": "the weight of the infonce loss"
        },
    )
